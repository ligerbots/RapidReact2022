...
public class CoastExtendElevator extends CommandBase {
  ...
  public void initialize() {
    ...
    m_elevatorHeight = new double[2];
    m_lastElevatorHeight = new double[2];
  ...
  public boolean isFinished() {
    ...
    boolean isFinished = (iterations > 5 && Math.abs(m_elevatorHeight[0] - m_lastElevatorHeight[0]) < Units.inchesToMeters(0.05) && 
      Math.abs(m_elevatorHeight[1] -  m_lastElevatorHeight[1]) < Units.inchesToMeters(0.05));
    m_lastElevatorHeight = m_elevatorHeight;
    return isFinished;
